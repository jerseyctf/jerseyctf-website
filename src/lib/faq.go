	...
	return []Faq{
		{
			...
			Answer:   "JerseyCTF is a beginner-friendly Capture the Flag competition that aims to inspire interest in cybersecurity. Organized by the NJIT <a target='_blank' href=https://njit.acm.org>Association for Computing Machinery</a>, the <a target='_blank' href= https://njiticc.com>NJIT Information and Cybersecurity Club</a>, and the <a target='_blank' href=https://sci.njit.edu>NJIT SCI Students</a> program, it is geared towards students, beginners, and professionals alike. JerseyCTF provides participants with jeopardy-style questions in categories including cryptography, forensics, binary exploitation/reversing, open-source intelligence, and web exploitation.  JerseyCTF features a track parallel to the CTF competition, consisting of presentations and panels with renowned speakers from industry and government.",
		},
		{
